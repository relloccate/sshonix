    ...
    <div class="right scroll-theme">
        ...
        <div class="mode-os">
            ...
            <div class="os">
                <span>OS</span>
                <div class="types">
                    <label v-tooltip="`On linux instances with 'SSH + SFTP' mode, SFTP will use linux commands for: delete, cut, move, copy files. Which makes working with files much faster.`">
            ...
            this.$ConfirmMenu({
                ...
                accept: {
                    ...
                    event: () => {
                        ...
                        StoreServers.remove(this.selectedData.id);
                    }
                },
                decline: {
                    text: 'BACK',
